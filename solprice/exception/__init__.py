...
def error_message_detail(error: Exception, error_detail: sys) -> str:
    ...
    _, _, exc_tb = error_detail.exc_info() ## exc_info() returns a tuple containing the exception type, value, and traceback object
...
class MyException(Exception):
    ...
    def __init__(self, error_message: str, error_detail: sys):
        """
        Initializes the exception with a custom error message and the sys module to access traceback details.
